...
%-------------------------------------------------------------------------------
params.numGradients = 100;
params.whatGradients = 'spatialLag'; % 'linear' 'poly', 'Gaussian', 'GaussianFixedScale', 'ExpDecaySingle'
params.ensembleParams = struct();
params.ensembleParams.rho = 0.21; % relative strength of spatial autocorrelation (relative to noise)
...
%-------------------------------------------------------------------------------
params.subsampleSpace = 500; % only keep this many random points for spatial analysis
params.numBins = 25;
